  ...
  return <section className="relative min-h-screen flex items-center justify-center pt-20">
      ...
      <div className="section-container relative z-10">
        <div className="max-w-4xl mx-auto text-center">
          ...
          {/* Main Headline */}
          <h1 className="mb-6 animate-fade-up" style={{
          ...
          {/* Subheading */}
          <p className="text-lg md:text-xl text-muted-foreground max-w-2xl mx-auto mb-10 leading-relaxed animate-fade-up" style={{
